...
| `template`       | Object | (Optional) If applicable, the StatWrap template that was used to create the project. If this is missing, null, or empty, it means we don't know what template was used to create the project - such as for an imported project. This object will contain `id` and `version` attributes. |
...
| `externalAssets` | Object | A root container with children [Asset](Assets.md) objects that live outside of the project root directory.                                                                                                                                                                              |
