  ...
  describe('AssetUtil', () => {
    ...
    describe('getAllDependencies', () => {
      it('should handle empty/invalid inputs', () => {
        expect(AssetUtil.getAllDependencies(null).length).toEqual(0);
        expect(AssetUtil.getAllDependencies(undefined).length).toEqual(0);
      });
      it('should build the list of assets even when there are no dependencies', () => {
        ...
        expect(AssetUtil.getAllDependencies(asset).length).toEqual(4);
      });
      it('should build the list of assets and dependencies', () => {
        ...
        const dependencies = AssetUtil.getAllDependencies(asset);
    ...
    describe('getAllDependenciesAsGraph', () => {
      it('should handle empty/invalid inputs', () => {
        expect(AssetUtil.getAllDependenciesAsGraph(null)).toEqual({ nodes: [], links: [] });
        expect(AssetUtil.getAllDependenciesAsGraph(undefined)).toEqual({ nodes: [], links: [] });
      });
      it('should build an empty graph when there are no dependencies', () => {
        ...
        const graph = AssetUtil.getAllDependenciesAsGraph(asset);
