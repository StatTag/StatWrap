  ...
  describe('assets', () => {
    ...
    describe('constructor', () => {
      ...
      it('should create an indexed version of the content type/file extension configuration', () => {
        ...
        console.log(service.assetContentTypesByCategory);
    ...
    describe('assetContentType', () => {
      ...
      it('should identify R code files as code', () => {
        ...
        expect(service.assetContentTypes('test.r.txt', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('test.rnw.txt', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('.r', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('.r.txt', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('.rnw', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('.snw.txt', stat)).toStrictEqual(['other']);
        stat.isFile.mockReturnValue(false);
      ...
      it('should identify R data files as data', () => {
        ...
        expect(service.assetContentTypes('test.rdata.txt', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('.rdata', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('.rda.txt', stat)).toStrictEqual(['other']);
        stat.isFile.mockReturnValue(false);
      ...
      it('should identify SAS code files as code', () => {
        ...
        expect(service.assetContentTypes('test.sas.txt', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('.sas', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('.sas.txt', stat)).toStrictEqual(['other']);
        stat.isFile.mockReturnValue(false);
      ...
      it('should identify Stata code files as code', () => {
        ...
        expect(service.assetContentTypes('test.do.txt', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('.mata', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('.ado.txt', stat)).toStrictEqual(['other']);
        stat.isFile.mockReturnValue(false);
      ...
      it('should identify Stata data files as data', () => {
        ...
        expect(service.assetContentTypes('test.dta.txt', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('.dta', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('.dta.txt', stat)).toStrictEqual(['other']);
        stat.isFile.mockReturnValue(false);
      ...
      it('should identify SAS data files as data', () => {
        ...
        expect(service.assetContentTypes('test.sd7.txt', stat)).toStrictEqual(['other']);
        ...
        expect(service.assetContentTypes('.sd7.txt', stat)).toStrictEqual(['other']);
        expect(service.assetContentTypes('.sas7bdat.txt', stat)).toStrictEqual(['other']);
        stat.isFile.mockReturnValue(false);
      ...
      it('should identify general data files as data', () => {
        ...
        expect(service.assetContentTypes('test.xls.txt', stat)).toStrictEqual(['other']);
